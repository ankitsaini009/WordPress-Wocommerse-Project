...
<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
	...
	<div class="u-columns col2-set" id="customer_login">
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <p><input class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="password" id="password" autocomplete="current-password" required aria-required="true" /></p>
			...
			<p><button type="submit" class="woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button></p>
